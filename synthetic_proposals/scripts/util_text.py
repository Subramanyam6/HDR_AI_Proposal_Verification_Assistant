...
def gather_section_text(proposal: Dict[str, Any]) -> Dict[str, str]:
    ...
    if letter:
        sections["letter"] = flatten_paragraphs(ensure_list(letter.get("body", [])))
    ...
    if qualifications:
        ...
        sections["qualifications"] = flatten_paragraphs(parts)
    ...
    if staffing:
        ...
        sections["staffing"] = flatten_paragraphs(staffing_parts)
    ...
    if subs_section:
        ...
        sections["subconsultants"] = flatten_paragraphs(subs_parts)
    ...
    if work_approach:
        ...
        sections["work_approach"] = flatten_paragraphs(parts)
    ...
    if schedule:
        ...
        sections["schedule"] = flatten_paragraphs(schedule_parts)
    ...
    if references:
        ...
        sections["references"] = flatten_paragraphs(ref_lines)
