...
export default function DecryptedText({
  ...
  // Initialize scrambled text when component mounts if using view animation
  useEffect(() => {
    if ((animateOn === 'view' || animateOn === 'both') && !hasAnimated) {
  ...
  }, [animateOn, hasAnimated, text, useOriginalCharsOnly, characters]);
